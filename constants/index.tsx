...
export const experiences = [
  {
    ...
    link: "https://www.porsline.ir/",
    achievements: [
      "Successfully improved the software performance by reducing the number and time of rerenders by up to 60% with the help of React Profiler",
      "Contribute to a cleaner codebase and reduced errors through active participation in code reviews",
      "Collaborate closely with Design and Back-End teams to achieve optimal user experience",
    ],
  },
  {
